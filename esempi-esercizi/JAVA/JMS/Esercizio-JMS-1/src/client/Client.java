...
public class Client {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// istaniamo, dopo aver recuperato da jndi, i riferimenti delle code
			// richiesta dove invieremo i nostri messaggi
			// risposta dove posizioneremo il listener in attesa di ricezione
			...
			for(int i = 0; i < N; i++){
				...
				String req = richieste[(int)((Math.random() * 100) % 2)];
				msg.setText(req + "#" + id);
