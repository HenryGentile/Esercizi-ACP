...
public class ClientThread extends Thread {
	...
	private IGestoreSportello gestore; //riferimento dell'oggetto remoto gestito dal creatore dei thread
	...
	public void run() {
		...
		//nuova libreia java.util.Random capire alcune funzionalità per poterlo utilizzare
